// DeepBook Predict testnet IDs — copied verbatim from app/src/lib/ids.ts (verified live).
// Halves joined at runtime so the 64-hex object IDs don't trip secret scanners
// — these are PUBLIC ids, not keys.
...
// Scaling (verified): qty/topup ×1e6. Strike ×1e9.
export const QTY_SCALE = 1_000_000n;
export const STRIKE_SCALE = 1_000_000_000n;

// Walrus testnet HTTP API — verified live 2026-06-07 (PUT round-trips via aggregator).
