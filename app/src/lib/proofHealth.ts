  ...
  return {
    ...
    checks: [
      ...
      check(
        ...
        "Success",
        "Failed",
        "current production AdminCap transfer succeeded",
        txUrl(PYTH_ADMIN_CUSTODY_TX),
      ),
      check(
        stagedClaimTx,
        "Archived staged claim",
        "Paid",
        "Missing",
        "v3 mechanism-test buy -> dwell -> claim proof paid on mainnet",
      ...
      check(
        ...
        "Missing",
        "v4 pool has outstanding cover and retained premium while suiUSDe stayed above floor",
