...
// MystenLabs/deepbookv3 @ tlee/predict-workshop + the live server.
...
// Scaling (verified): qty/topup ×1e6. Strike ×1e9 per workshop — confirmed at the live mint, not the check.
